...
namespace Control_Impressora.Controllers
{
    public class AdministrationController : Controller
    {
        ...
        {
            var users = userManager.Users.Include(a=>a.Endereco);
            return View(users);
        }
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            var enderr = _contexto.Endereco.FirstOrDefault(u => u.Id == user.EnderecoId);

            ViewBag.Endereco = new SelectList(_contexto.Endereco, "Id", "Base", enderr.Id);
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel model)
        {
            ...
            else
            {
                ...
                user.EnderecoId = model.EnderecoId;
